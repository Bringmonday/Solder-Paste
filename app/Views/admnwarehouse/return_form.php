                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?= site_url('user/export_to_excel') ?>" style="float: right; margin-top: 10px;" class="btn btn-rs mb-3 ">Download Excel</a>
                            <i class='fas fa-file-excel'style="float: right; margin-top: 20px;"></i>
                        </div>
                        <div class="card-body">
                    ...
                    <div>
                        <button type="button" class="btn btn-scr" style="margin-top: 10px" onclick="window.location.href='<?= base_url('admnwarehouse/scrap_to_return'); ?>'">Edit Status</button>
                    </div>
            </div>
        </div>
    </section>
